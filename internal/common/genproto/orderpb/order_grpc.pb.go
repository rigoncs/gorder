...
const (
	...
	OrderService_UpdateOder_FullMethodName  = "/orderpb.OrderService/UpdateOder"
)
...
type OrderServiceClient interface {
	...
	UpdateOder(ctx context.Context, in *Order, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *orderServiceClient) UpdateOder(ctx context.Context, in *Order, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, OrderService_UpdateOder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServiceServer interface {
	...
	UpdateOder(context.Context, *Order) (*emptypb.Empty, error)
}
...
func (UnimplementedOrderServiceServer) UpdateOder(context.Context, *Order) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateOder not implemented")
}
...
func _OrderService_UpdateOder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Order)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).UpdateOder(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderService_UpdateOder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).UpdateOder(ctx, req.(*Order))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateOder",
			Handler:    _OrderService_UpdateOder_Handler,
		},
	},
